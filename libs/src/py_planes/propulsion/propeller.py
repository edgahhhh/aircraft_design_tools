...
class Propeller():
    ...
    def __init__(self, propeller_info, altitude=400.0):
        """ create propeller object from yaml file
        Arguments:
            propeller_info: path to yaml (path_like)
            altitude: altitude above sea level, m (float)
        ...
        self._rho = self.density_from_alt(altitude)   # defaults to 400m density
